          ...
          >
            <Slider ref={(c) => setSlider(c)} {...settings}>
              ...
              <div className="slider-item">
                ...
                <div className="p-para">
                  <p>
                    “Nomad Nurses has simplified my job search process. The ease
                    of using the app, has made finding locum positions a breeze.
                    The variety of available opportunities make it a go-to
                    platform for any dental nurse."
                  </p>
                </div>
              </div>{" "}
              <div className="slider-item">
                ...
                <div className="p-para">
                  <p>
                    “Nomad Nurses has exceeded our expectations. The platform's
                    reliability in providing skilled nurses has been crucial for
                    our practice's success. The time saved on administrative
                    tasks, thanks to the efficient interface, allows us to focus
